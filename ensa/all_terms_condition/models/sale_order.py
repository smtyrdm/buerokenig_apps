...
class SaleOrder(models.Model):
    ...
    # ondelete='restrict' -> term.condition kayıt silinmesini engeller. bu çok mantıklı
    ...
    sale_term = fields.Html(string='Term and Condition', readonly=True)
