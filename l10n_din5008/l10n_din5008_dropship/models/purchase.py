...
class PurchaseOrder(models.Model):
    ...
    def _compute_l10n_din5008_phone(self):
        for record in self:
            ...
            # if record.dest_address_id:
            #     if not record.dest_address_id.phone:
            #         record.l10n_din5008_phone = record.dest_address_id.parent_id.phone or ""
            #     else:
            #         record.l10n_din5008_phone = ""
            # else:
            #     record.l10n_din5008_phone = ""
    ...
    def _compute_l10n_din5008_email(self):
        ...
        # for record in self:
        #     if record.dest_address_id:
        #         if not record.dest_address_id.email:
        #             record.l10n_din5008_email = record.dest_address_id.parent_id.email or ""
        #         else:
        #             record.l10n_din5008_email = ""
        #     else:
        #         record.l10n_din5008_email = ""
